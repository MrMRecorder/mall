                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <div class="header-bottom-set dropdown">
                            <a href="/furn?action=page&pageNo=1">家居管理</a>
                        </div>
                        <%--<div class="header-bottom-set dropdown">--%>
                        <%--    <a href="#">订单管理</a>--%>
                        <%--</div>--%>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <form action="manage/furn?id=${requestScope.furn.id}&action=update&pageNo=${param.pageNo}" method="post" enctype="multipart/form-data">
                    <%--?id=${requestScope.furn.id}&action=update&pageNo=${param.pageNo}" method="post" enctype="multipart/form-data"--%>
                    <%--传id--%>
