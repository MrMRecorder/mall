    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.add-to-cart").click(function () {
                ...
                // location.href = "cart?action=addItem&id=" + furnId + "&d=" + new Date();
                //发送请求 -> 改进成ajax请求
                $.getJSON("cart",{
                    ...
                    if (data.url == undefined){
                        // var $span = $("<span class=\"header-action-num\"></span>");
                        // $span.text(data.cartTotalCount);
                        // $("i.icon-handbag").after($span)
                         $("span.header-action-num").text(data.cartTotalCount);
                    }else {
                        $("span.header-action-num").hide();
                    ...
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="customer">
                        ...
                        <c:if test="${not empty sessionScope.user }">
                            ...
                            <div class="header-bottom-set dropdown">
                                <a href="member?action=logout">退出登录</a>
                            </div>
                        </c:if>
                        ...
                        <a href="views/cart/cart.jsp"
                           <%--在main.js里对offcanvas-toggle pr-0这个class进行了组织超链接跳转操作
                           这里我们先删掉--%>
                           class="header-action-btn header-action-btn-cart <%--offcanvas-toggle pr-0--%>">
                            <i class="icon-handbag"> 购物车</i>
                            <%--${sessionScope.cart.totalCount}的本质就是调用cart对象的getTotalCount方法--%>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <c:if test="${furn.stock == 0}">
                                                <button title="Add To Cart" class="add-to-cart" style="pointer-events: none">
                                                    该货源暂时缺货
                                                </button>
                                            </c:if>
