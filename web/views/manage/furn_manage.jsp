                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <c:if test="${not empty sessionScope.admin }">
                            <div class="header-bottom-set dropdown">
                                <a>管理员【${sessionScope.admin.username}】</a>
                            </div>
                            <div class="header-bottom-set dropdown">
                                <a href="manage?action=logout">管理员登出</a>
                            </div>
                        </c:if>
                        <div class="header-bottom-set dropdown">
                            <%--添加完跳转到添加后的页面——最后一页--%>
...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
                            ...
                            <c:forEach items="${requestScope.page.items}" var="furn">
                                <tr>
                                    ...
                                    <td class="product-remove">
                                        <a href="manage/furn?action=showFurn&id=${furn.id}&pageNo=${requestScope.page.pageNo}"><i
                                                class="icon-pencil"></i></a>
                                        <a class="deleteCss"
                                           href="manage/furn?action=del&id=${furn.id}&pageNo=${requestScope.page.pageNo}"><i
        ...
        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
            <ul>
                <%--如果当前页 > 1 , 就显示上一页--%>
                    <li><a href="manage/furn?action=page&pageNo=1">首页</a></li>
                <c:if test="${requestScope.page.pageNo > 1}">
                    <li><a href="manage/furn?action=page&pageNo=${requestScope.page.pageNo - 1}">上一页</a></li>
                </c:if>
                ...
                <c:forEach begin="${begin}" end="${end}" var="i">
                    ...
                    <c:if test="${i == requestScope.page.pageNo}">
                        <li><a class="active" href="manage/furn?action=page&pageNo=${i}">${i}</a></li>
                    </c:if>
                    <%--不是的话正常显示--%>
                    <c:if test="${i != requestScope.page.pageNo}">
                        <li><a href="manage/furn?action=page&pageNo=${i}">${i}</a></li>
                    </c:if>
                </c:forEach>
                <%--如果当前页 < 总页数 , 就显示下一页--%>
                <c:if test="${requestScope.page.pageNo < requestScope.page.pageTotalCount}">
                    <li><a href="manage/furn?action=page&pageNo=${requestScope.page.pageNo + 1}">下一页</a></li>
                </c:if>
                    <li><a href="manage/furn?action=page&pageNo=${requestScope.page.pageTotalCount}">尾页</a></li>
            ...
            <div class="container">
                <div class="row flex-sm-row-reverse">
                    <div class="col-md-6 text-right">
                        ...
                        <%--    &lt;%&ndash;img src="#" 会去请求当前页url http://localhost:8080/jiaju_mall/# &ndash;%&gt;--%>
